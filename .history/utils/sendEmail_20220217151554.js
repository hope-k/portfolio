...
xons SibApiV3Sdk = require('sib-api-v3-sdk');
xons defaultClient = SibApiV3Sdk.ApiClient.instance;

xons apiKey = defaultClient.authentications['api-key'];
apiKey.apiKey = 'YOUR_API_V3_KEY';
xons apiInstance = new SibApiV3Sdk.EmailCampaignsApi();
xons emailCampaigns = ({ name, from, message }) => {
