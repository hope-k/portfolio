                ...
                <Flex alignItems={'center'} justifyContent={'space-between'}>
                    ...
                    <Flex color='white'>
                        <Flex display={['none', 'inline-flex']}>
                            ...
                            <NextLink href='/go'>
                                <Text _hover={{color: 'purple.300'}} transition={'all .'} mr={'6'} letterSpacing={'1.7px'} cursor={'pointer'} color={router.pathname === '/works' ? 'teal' : 'white'}>Works</Text>
                            </NextLink>
                            <NextLink href='/'>
                                <Text _hover={{color: 'purple.300'}} transition={'all .'} mr={'6'} letterSpacing={'1.7px'} cursor={'pointer'} color={router.pathname === '/contact' ? 'teal' : 'white'}>Contact</Text>
                            </NextLink>
                            <NextLink href='/'>
                                <Text _hover={{color: 'purple.300'}} transition={'all .'} mr={'6'} letterSpacing={'1.7px'} cursor={'pointer'} color={router.pathname === '/about' ? 'teal' : 'white'}>About</Text>
                            </NextLink>
                        </Flex>
