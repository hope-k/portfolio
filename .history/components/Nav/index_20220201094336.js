                        ...
                        <Flex color='white'>
                            <Flex display={['none', 'inline-flex']}>
                                ...
                                <NextLink href='/#works' scroll={false}>
                                    <Text id='links' _hover={{ color: 'purple.300' }} transition={'all .4s ease'} mr={'6'} letterSpacing={'1.7px'} cursor={'pointer'} color={router.pathname.in === '/#works' ? 'teal' : 'white'}>Works</Text>
                                </NextLink>
