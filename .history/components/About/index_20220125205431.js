        ...
        <Container d='flex' maxW={['21rem', '30rem', '70rem']}>
            <Flex alignItems={'center'} justifyContent={'center'} w='100%'>
                ...
                <Flex flexDir={['column', 'row']} mt='7rem' justifyContent={'center'} w='100%' flexWrap='nowrap' alignItems={'center'}>
                    ...
                    <Box  ml={['0','10rem']} mt={['2rem', '-6.5rem']}>
                        <Text fontWeight={'700'} fontSize={'1.2rem'} mb='1rem' color='#ccc'>Skills</Text>
                        <Box>
                            <Tag style={{marginBottom: '5px',fontWeight: '620', display: 'inline-block'}} color='processing'>REACT</Tag>
                            <Tag style={{marginBottom: '5px',fontWeight: '620'}}>NEXT JS</Tag>
                            <Tag style={{marginBottom: '5px', fontWeight: '620' }} color='#87d068'>NODE/EXPRESS JS</Tag>
                            <Tag style={{marginBottom: '5px',fontWeight: '620'}} color='success'>MONGO DB</Tag>
                            <Tag style={{marginBottom: '5px',fontWeight: '620'}} color='orange'>HTML5</Tag>
                            <Tag style={{marginBottom: '5px',fontWeight: '620'}} color='pink'>CSS/SCSS</Tag>
                        </Box>
