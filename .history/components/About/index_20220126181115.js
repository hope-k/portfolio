...
const About = () => {
    ...
    useLayoutEffect(() => {
        ...
        t1.from('#about', {
            scrollTrigger: {
                ...
                start: 'top top',
                end: () => '+=' + aboutRef.current.offsetWidth,
                markers: true,
                horizontal: true
    ...
    return (
        <Container id='aboutTrigger' d='flex' maxW={['21rem', '30rem', '70rem']}>
            <Flex  ref={aboutRef} alignItems={'center'} justifyContent={'center'} w='100%' id='page'>
