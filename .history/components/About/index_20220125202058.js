                ...
                <Flex flexDir={['column', 'row']} mt='7rem' justifyContent={'center'} w='100%' flexWrap='nowrap' alignItems={'center'} h='100%'>
                    ...
                    <Box ml={['0','10rem']} mt={['2rem', '-7.5rem']} >
                        ...
                        <Box d='flex' color='#ccc'>
                            <Box m='-0.5.5rem' p={1} fontSize={13} bg='gray'>REACT</Box>
                            <Box m='-0.5.5rem'>NEXT JS</Box>
                            <Box m='-0.5.5rem'>NODE/EXPRESS JS</Box>
                            <Box m='-0.5.5rem'>MONGO DB</Box>
                            <Box m='-0.5.5rem'>HTML</Box>
                            <Box m='-0.5.5rem'>CSS/SCSS</Box>
                        </Box>
