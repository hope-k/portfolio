                ...
                <Flex ref={ref2} position='relative' top={['4rem','5.4rem']} flexDir={['column', 'row']} justifyContent={'center'} w='100%' flexWrap='nowrap' alignItems={'center'}>
                    <Box maxW={'70ch'} color='#ccc'>
                        ...
                        <Text id='aboutSection' fontSize={['.95rem', '.9rem']} className='outfit' letterSpacing={'1px'}>
                            I’m Hope Kumordzie and i am passionate Fullstack Web Developer. I enjoy using web technologies to build amazing modern fullstack web applications and RESTful API that focus on solving problems for different niches.  I also services as a freelancer. I am currently still in the university working hard to gain my degree in computer science.
                        </Text> 
                        <br />
