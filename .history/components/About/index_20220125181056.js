            ...
            <Flex alignItems={'center'} justifyContent={'center'} w='100%'>
                ...
                <Flex mt='7rem' justifyContent={'center'} w='100%' flexWrap='nowrap' alignItems={'center'} h='100%'>
                    <Box  justifySelf={'flex-start'}>
                        <Text>Hi There!</Text>
                        <Text maxW={'50ch'}>I’m Hope Kumordzie and i am Fullstack Web Developer. I ha, I’m working as web developer.i have developed many website and also provided my services to college students by getting their projects ready ASAP as a freelancer I have been part of some very good web design projects.</Text>
                    </Box>
                    <Box ml='10rem'>
                        <Text>Skills</Text>
                        <Box d='flex'>
