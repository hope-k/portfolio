        ...
        <Container id='about' d='flex' maxW={['21rem', '30rem', '70rem']}>
            <Flex alignItems={'center'} justifyContent={'center'} w='100%' id='page'>
                ...
                <Flex ref={ref2} position='relative' top={['4rem','5.4rem']} flexDir={['column', 'row']} justifyContent={'center'} w='100%' flexWrap='nowrap' alignItems={'center'}>
                    <Box maxW={'65ch'} color='#ccc'>
                        <Text fontWeight={'700'} fontSize={'1.2rem'} mb='1rem' mt='3rem' className='poiret'>Hi There!</Text>
                        <Text id='aboutSection' className='poiret' letterSpacing={'1px'}>
                        ...
                        <br />
                        <Text id='aboutSection' className='poiret' letterSpacing={'1px'}>I would love to hear from you. Whether its a project, job or opportunity at something great. Feel free to contact me</Text>
