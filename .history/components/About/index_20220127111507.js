...
const About = () => {
    ...
    useLayoutEffect(() => {
         t1.current = gsap.timeline({
            ...
            duration: .8,
            ease: 'Power$.easeOut'
        }).to(aboutRef.current, { textShadow: '0px 0px 15px #008080', repeat: -1,repeatDelay})
        ...
        <Container id='scroller' d='flex' maxW={['21rem', '30rem', '70rem']}>
            <Flex alignItems={'center'} justifyContent={'center'} w='100%' id='page'>
                <Flex alignItems={'center'} justifyContent={'center'} top={['6rem', '8rem']} flexDir={'column'} position={'absolute'}>
                    <Text transition={'all'}  mb='1rem' fontWeight={'bold'} color='teal' ref={aboutRef} id='about'>ABOUT</Text>
