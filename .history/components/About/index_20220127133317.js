    ...
    return (
        ...
        <Container id='scroller' d='flex' maxW={['21rem', '30rem', '70rem']}>
            <Flex alignItems={'center'} justifyContent={'center'} w='100%' id='page'>
                <Flex alignItems={'center'} justifyContent={'center'} top={['4rem', '8rem']} flexDir={'column'} position={'absolute'}>
                    <Text transition={'all .14s ease'}  mb='1rem' fontWeight={'bold'} color='teal' ref={aboutRef} id='about'>ABOUT</Text>
                ...
                <Flex ref={ref2} position='relative' top='5.4rem' flexDir={['column', 'row']} justifyContent={'center'} w='100%' flexWrap='nowrap' alignItems={'center'}>
                    <Box maxW={'60ch'} color='#ccc'>
                        ...
                        <br />
                        <Text id='about'>I would love to hear from you. Whether its a project, job or opportunity at something great. Feel free to contact me</Text>
                    ...
                    <Box ml={['0', '10rem']} mt={['3rem', '0']}>
                        ...
                        <Box>
                            ...
                            <Tag id='about' style={{ marginBottom: '10px', fontWeight: '620' }}>NEXT JS</Tag>
                            <Tag id='about' style={{ marginBottom: '10px', fontWeight: '620' }} color='#87d068'>NODE/EXPRESS JS</Tag>
                            <Tag id='about' style={{ marginBottom: '10px', fontWeight: '620' }} color='success'>MONGO DB</Tag>
                            <Tag id='about' style={{ marginBottom: '10px', fontWeight: '620' }} color='orange'>HTML5</Tag>
                            <Tag id='about' style={{ marginBottom: '10px', fontWeight: '620' }} color='pink'>CSS/SCSS</Tag>
                            <Tag id='about' style={{ marginBottom: '10px', fontWeight: '620' }}>GIT</Tag>
                        </Box>
