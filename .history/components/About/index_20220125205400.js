            ...
            <Flex alignItems={'center'} justifyContent={'center'} w='100%'>
                ...
                <Flex flexDir={['column', 'row']} mt='7rem' justifyContent={'center'} w='100%' flexWrap='nowrap' alignItems={'center'}>
                    ...
                    <Box  ml={['0','10rem']} mt={['2rem', '-6.5rem']}>
                        ...
                        <Box>
                            <Tag style={{margin: ''fontWeight: '620', display: 'inline-block'}} color='processing'>REACT</Tag>
                            <Tag style={{margin: ''fontWeight: '620'}}>NEXT JS</Tag>
                            <Tag style={{margin: '' fontWeight: '620' }} color='#87d068'>NODE/EXPRESS JS</Tag>
                            <Tag style={{margin: ''fontWeight: '620'}} color='success'>MONGO DB</Tag>
                            <Tag style={{margin: ''fontWeight: '620'}} color='orange'>HTML5</Tag>
                            <Tag style={{margin: ''fontWeight: '620'}} color='pink'>CSS/SCSS</Tag>
                        </Box>
