    ...
    return (
        <Container d='flex' maxW={['21rem', '30rem', '70rem']}>
            <Flex alignItems={'center'} justifyContent={'center'} w='100%'>
                ...
                <Flex flexDir={['column']} mt='7rem' justifyContent={'center'} w='100%' flexWrap='nowrap' alignItems={'center'} h='100%'>
                    <Box justifySelf={'flex-start'} maxW={'60ch'}>
                        <Text fontWeight={'700'} fontSize={'1.2rem'} mb='1rem'>Hi There!</Text>
                        <Text>
