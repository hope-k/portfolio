            ...
            <Flex alignItems={'center'} justifyContent={'center'} w='100%'>
                ...
                <Flex flexDir={['column', 'row']} mt='7rem' justifyContent={'center'} w='100%' flexWrap='nowrap' alignItems={'center'}>
                    ...
                    <Box  ml={['0','10rem']} mt={['2rem', '-6.5rem']}>
                        ...
                        <Box bg='yellow' d='flex' flexWrap={'nowrap'} flexDir={{'column, ['ro]
                            <Tag style={{fontWeight: '620', display: 'inline-block'}} color='processing'>REACT</Tag>
                            <Tag style={{fontWeight: '620'}}>NEXT JS</Tag>
                            <Tag style={{ fontWeight: '620' }} color='#87d068'>NODE/EXPRESS JS</Tag>
                            <Tag style={{fontWeight: '620'}} color='success'>MONGO DB</Tag>
                            <Tag style={{fontWeight: '620'}} color='orange'>HTML5</Tag>
                            <Tag style={{fontWeight: '620'}} color='pink'>CSS/SCSS</Tag>
                        </Box>
