            ...
            <Flex alignItems={'center'} justifyContent={'center'} w='100%'>
                ...
                <Flex mt='7rem' justifyContent={'center'} w='100%' flexWrap='nowrap' alignItems={'center'} h='100%'>
                    <Box  justifySelf={'flex-start'}>
                        <Text>Hi There!</Text>
                        <Text maxW={'50ch'}>I’m Hope Kumordzie and i am passionate Fullstack Web Developer using web technologies to build amazing modern web applications and focusing on solving problems for different niches.  I have  also provide my services to college students by getting their projects ready as a freelancer. \</Text>
                    </Box>
                    <Box ml='10rem'>
                        <Text>Skills</Text>
                        <Box d='flex'>
