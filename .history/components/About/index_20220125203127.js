                ...
                <Flex flexDir={['column', 'row']} mt='7rem' justifyContent={'center'} w='100%' flexWrap='nowrap' alignItems={'center'}>
                    ...
                    <Box ml={['0','10rem']} mt={['2rem', '-7.5rem']} >
                        ...
                        <Box d='flex' color='#ccc' flexWrap={'nowrap'}>
                            <Tag m='.5rem' p='.3rem' h='1.5rem' fontSize={12} fontWeight bg='gray'>REACT</Tag>
                            <Tag m='.5rem'>NEXT JS</Tag>
                            <Tag m='.5rem'>NODE/EXPRESS JS</Tag>
                            <Tag m='.5rem'>MONGO DB</Tag>
                            <Tag m='.5rem'>HTML</Tag>
                            <Tag m='.5rem'>CSS/SCSS</Tag>
                        </Box>
