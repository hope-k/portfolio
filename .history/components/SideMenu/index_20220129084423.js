...
const SideMenu = ({ open, toggleOpen }) => {
    ...
    return (
        ...
        <>
            ...
            <Box display={['flex', 'none']} className='side-menu' background={'rgba(36, 36, 36, .88)'} opacity={'0'} zIndex={'9'} id='sideMenuCurtain' left='0' top='0' bottom='0' width='15vw' position={'absolute'}>
            </Box>
        </>
