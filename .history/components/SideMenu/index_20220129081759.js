...
const SideMenu = ({ open, toggleOpen }) => {
    ...
    useLayoutEffect(() => {
        ...
        t1.current = gsap.timeline({ paused: true, defaults: { duration: .65 } })
            ...
            .from('#sideMenuCurtain', { xPercent: -100 }, '-=.55')
            .to('#sideMenuCurtain', { opacity: 1 }, '-=.55')
    ...
    return (
        ...
        <>
            ...
            <Box className='side-menu' background={'rgba(36, 36, 36, .45)'} opacity={'0'} zIndex={'9'} id='sideMenuCurtain' left='0' top='0' bottom='0' width='15%' position={'absolute'}>
            </Box>
        </>
