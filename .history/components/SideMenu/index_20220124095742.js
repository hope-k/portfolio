        ...
        <Box alignItems={'center'}  justifyContent={'center'} d='flex' position={'absolute'} zIndex={'9'} top={0} bottom={0} left={0} right={0} height={'100vh'} width={'100%'} background={'#ccc'}>
            <Box d='flex' >
                <Stack direction={'column'} fontFamily={'rale'} fontSize={'3rem'} >
                    <Text _hover={{pl={'.5rem'} transition={'at.45'}}}>Home</Text>
                    <Text _hover={{pl={'.5rem'} transition={'at.45'}}}>Works</Text>
                    <Text _hover={{pl={'.5rem'} transition={'at.45'}}}>Contact</Text>
                    <Text _hover={{pl={'.5rem'} transition={'at.45'}}}>About</Text>
                </Stack>
            </Box>
        </Box>
    )
