...
const SideMenu = ({ open, toggleOpen }) => {
    ...
    return (
        ...
        <>
            ...
            <Box w='85vw' className='side-menu' display={['flex', 'none']} id='sideMenu' opacity={0} alignItems={'center'} justifyContent={'center'} d='flex' position='absolute' zIndex={'9'}  right={'0'} height={'100vh'} top='0' bottom='0' background={'rgba(36, 36, 36, .85)'}>
                <Box d='flex'>
