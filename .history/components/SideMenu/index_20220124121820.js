...
const SideMenu = ({ open }) => {
    ...
    return (
        ...
        <>
            <Box id='sideMenu' display={['flex', 'none']} opacity={'1'} alignItems={'center'} justifyContent={'center'} d='flex' position='fixed' zIndex={'9'} top={0} bottom={0} right={'-rem'}  height={'100vh'}  background={'rgba(36, 36, 36, 1)'}>
                <Box d='flex'>
