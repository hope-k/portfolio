...
const SideMenu = ({ open }) => {
    ...
    useLayoutEffect(() => {
        ...
        t2.from('#stack', { x: 21, opacity: 0 })
            .from(link1.chars, { x: 20, opacity: 0, ease: 'power4', stagger: { each: 0.01 } })
            .from(link2.chars, { x: 20, opacity: 0, ease: 'power4', stagger: { each: 0.03 } })
            .from(link3.chars, { x: 20, opacity: 0, ease: 'power4', stagger: { each: 0.03 } })
            .from(link4.chars, { x: 20, opacity: 0, ease: 'power4', stagger: { each: 0.03 } })
