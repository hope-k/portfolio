...
const SideMenu = ({ open }) => {
    ...
    return (
        ...
        <>
            <Box display={['flex', 'none']} alignItems={'center'} justifyContent={'center'} d='flex' position={'absolute'} zIndex={'9'} top={0} bottom={0} left={0} right={0} height={'100vh'} width={`${open  }`} background={'rgba(36, 36, 36, 1)'}>
                <Box d='flex' >
