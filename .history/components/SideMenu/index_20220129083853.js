...
const SideMenu = ({ open, toggleOpen }) => {
    ...
    useLayoutEffect(() => {
        ...
        t1.current = gsap.timeline({ paused: true, defaults: { duration: .65 } })
            .to('#sideMenu', {  left: '8rem': '-85vw', opacity: 1, ease: 'Expo.easeInOut' })
    ...
    return (
        ...
        <>
            ...
            <Box w='85vw' className='side-menu' display={['flex', 'none']} id='sideMenu' opacity={0} alignItems={'center'} justifyContent={'center'} d='flex' position='fixed' zIndex={'9'} top={0} bottom={0} height={'100vh'} background={'rgba(36, 36, 36, .85)'}>
                <Box d='flex'>
