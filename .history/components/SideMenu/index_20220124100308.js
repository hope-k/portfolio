        ...
        <Box alignItems={'center'}  justifyContent={'center'} d='flex' position={'absolute'} zIndex={'9'} top={0} bottom={0} left={0} right={0} height={'100vh'} width={'100%'} background={'#ccc'}>
            <Box d='flex' >
                <Stack  direction={'column'} fontFamily={'rale'} fontSize={'3rem'} >
                    <Text transition='all .45s ease-in' padding='0' _hover={{pl:'.5rem'}}>Home</Text>
                    <Text transition='all .45s ease-in' _hover={{pl:'.5rem'}}>Works</Text>
                    <Text transition='all .45s ease-in' _hover={{pl:'.5rem'}}>About</Text>
                    <Text transition='all .45s ease-in' _hover={{pl:'.5rem'}}>Contact</Text>
                </Stack>
            </Box>
        </Box>
    )
