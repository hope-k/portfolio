...
const SideMenu = ({ open, toggleOpen}) => {
    ...
    return (
        ...
        <>
            ...
            <Box w='95%' className='side-menu' display={['flex', 'none']} id='sideMenu' opacity={0} alignItems={'center'} justifyContent={'center'} d='flex' position='fixed' zIndex={'9'} top={0} bottom={0} right={'-15rem'} height={'100vh'} background={'rgba(36, 36, 36, .85)'}>
                <Box d='flex'>
                    ...
                    <Box bg='red' left='0' top='0' bottom='0' width='15%' position={'absolute'}>
