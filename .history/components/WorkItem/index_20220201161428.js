        ...
        <Container background={'rgba(36, 36, 36, .35)'} zIndex={'1'} d='flex' m='1rem' h='95vh' position={'relative'}>
            <Box>
                ...
                <Flex id='workTile' flexDir={'column'} alignItems={'center'} justifyContent={'center'}>
                    <Text color='#ccc' pb='1rem' mb='1rem' lineHeight={1.5} style={{ borderBottom: '2px solid teal', borderBottomWidth: '1px' }}>{title}</Text>
                    <Text mb={'2rem'} className='outfit' color='#ccc' pb='2rem' maxW={'35ch'}  textTransform={'capitalize'}>{description}</Text>
                    <Box zIndex={'10'} m='2rem' position='absolute' bottom='0' d='flex' justifyContent={'center'} alignItems={'center'}>
                        <Link href={link} passHref >
                            <Button w='15rem' colorScheme={'teal'} p='1.8rem' variant={'outline'}>View Project</Button>
                        </Link>
                    </Box>
                </Flex>
