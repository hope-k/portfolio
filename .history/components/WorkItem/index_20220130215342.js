...
const WorkItem = ({ title, description, laptopMock, phoneMock, phoneImage, link }) => {
    ...
    return (
        <Container background={'rgba(36, 36, 36, .35)'} zIndex={'1'} d='flex' m='1rem' h='100%'>
            <Box>
                ...
                <Flex h='0' opacity='0' id='workTile' flexDir={'column'} alignItems={'center'} justifyContent={'center'}>
