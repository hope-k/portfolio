...
const WorkItem = ({ title, description, laptopMock, phoneMock, phoneImage, link }) => {
    ...
    return (
        <Container background={'rgba(36, 36, 36, .35)'} zIndex={'1'} d='flex' m='1rem' h='95vh' position={'relative'} justifyContent={'center'}>
            <Box d='flex' width='10rem' position={'absolute'} top='0' h='.7rem' bg='yellow' borderBottomRightRadius={'.5rem'} borderBottomLeftRadius={'.5rem'}>
                <Box bg='black' borderRadius={'50%'} w='5px' h='5px'>
                    
                </Box>                <Box bg='black' borderRadius={'50%'} w='5px' h='5px'>
