...
const WorkItem = ({ title, description, laptopMock, phoneMock, phoneImage, link }) => {
    ...
    useLayoutEffect(() => {
        t2.current = gsap.timeline({ paused: true, defaults: { duration: .65 } })
    ...
    return (
        <Container background={'rgba(36, 36, 36, .35)'} zIndex={'1'} d='flex' m='1rem'>
            <Box>
                ...
                <Flex visibiliopacityty={'hidden'} id='workTile' ref={workTile} flexDir={'column'} alignItems={'center'} justifyContent={'center'}>
