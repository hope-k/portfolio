...
const WorkItem = ({ title, description, laptopMock, phoneMock, phoneImage, link }) => {
    ...
    return (
        <Container background={'rgba(36, 36, 36, .35)'} zIndex={'1'} d='flex' m='1rem' h='90vh' position={'relative'}>
            <Box>
                ...
                <Flex id='workTile' flexDir={'column'} alignItems={'center'} justifyContent={'center'}>
                    ...
                    <Text pb={'60rem'} className='outfit' color='#ccc' pb='2rem' maxW={'35ch'}  textTransform={'capitalize'}>{description}</Text>
