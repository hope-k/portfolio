                ...
                <Flex justifyContent={'space-around'} w='100%' pt={'15rem'}>
                    <Flex className='poiret' letterSpacing={'2px'} fontWeight={'900'}>
                        <Box color={'#ccc'}>
                            ...
                            <Input border focusBorderColor='teal.400' bg='black'/>

                            <Text my='1rem'>EMAIL ADDRESS</Text>
                            <Input focusBorderColor='teal.400' bg='black'/>                         
                            
                            <Text my='1rem'>I NEED HELP WITH...</Text>
                            <Textarea focusBorderColor='teal.400' resize={'vertical'} bg='black'/>

                            <Button my='2rem' variant={'outline'} colorScheme={'teal'}>Submit</Button>
                        </Box>
                    </Flex>
