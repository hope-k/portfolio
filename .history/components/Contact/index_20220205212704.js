            ...
            <Box alignItems={'center'} justifyContent={'center'} w='100%' d='flex'>
                ...
                <Flex justifyContent={'space-around'} w='100%' pt={'15rem'}>
                    <Flex className='poiret' letterSpacing={'2px'} fontWeight={'900'}>
                        <FormControl color={'#ccc'} onSubmit={() => submitForm()}>
                            <FormLabel my='1rem'>FULL NAME</FormLabel>
                            <Input
                                htmlFor='name'
                                type={'text'}
                                value={name}
                            ...
                            <FormLabel my='1rem'>EMAIL ADDRESS</FormLabel>
                            <Input
                                htmlFor='email'
                                value={email}
                            ...
                            <FormLabel my='1rem'>I NEED HELP WITH...</FormLabel>
                            <Textarea
                                htmlFor='message'
                                value={message}
                            ...
                            <Button type='submit' _hover={{ color: 'white', bg: 'teal', border: 'teal' }} my='2rem' variant={'outline'} colorScheme={'teal'}>Submit</Button>
                        </FormControl>
                    </Flex>
