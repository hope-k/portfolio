...
import { Flex, Box, Container, Text, Center, Input, Textarea } from '@chakra-ui/react';
                ...
                <Flex justifyContent={'space-around'} w='100%' pt={'15rem'}>
                    <Flex>
                        <Box color={'#ccc'}>
                            ...
                            <Input  focusBorderColor='teal.400' bg='blackAlpha.100'/>

                            <Text my='1rem'>EMAIL ADDRESS</Text>
                            <Input focusBorderColor='teal.400'/>                         
                            
                            <Text my='1rem'>I NEED HELP WITH...</Text>
                            <Textarea focusBorderColor='teal.400' resize={'vertical'} />
                        </Box>
                    </Flex>
