  ...
  return (
    ...
    <Container d='flex' justifyContent='center' maxW={['21rem', '41rem', '70rem']} h='100vh'>
      <Flex  alignItems={'center'} w='100%'>
        ...
        <Box transition={'all 1s ease-in'} background={'red'} p='4rem'>
          <Button transition={'padding 1s ease-in'} mb='1rem' _hover={{bg:'teal', px: '2rem'}} borderColor={'teal'} color='white' variant={'outline'}>LATEST PROJECTS</Button>
