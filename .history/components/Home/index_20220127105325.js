    ...
    <>
      ...
      <Box position={'relative'} bg='rgba(0 ,0 ,0, .87)' h='100vh' w='100%'>
        <Box m='0 auto' position={'absolute'} width={'100%'} h='10vh' top={'0'} bg='rgba(0, 0, 0, .2)' left='0' >
          <Box posiiton='relative'>
            <Text left='0' position={'absolute'} transform={'translate(50%, 50%)'} ml='3rem' fontSize={['1rem', '4rem']} letterSpacing={['.5rem', '2rem']} fontWeight={'900'} color='rgba(192,192,192,.025)' >
              HK
            </Text>
          </Box>
        </Box>
