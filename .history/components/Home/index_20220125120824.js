  ...
  return (
    ...
    <>
      <Flex ref={panelContainer} w='300%' h='100vh' flexWrap={'nowrap'}>
        ...
        <Box ref={panel} id='panel' position={'relative'} background={'yellow'} d='flex' justifyContent='center' alignItems={'center'} h='100%' w='100%'>

        </Box>
        <Box ref={panel} id='panel' position={'relative'} background={'red'} d='flex' justifyContent='center' alignItems={'center'} h='100%' w='100%'>
