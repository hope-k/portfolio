    ...
    <Container d='flex' justifyContent='center' maxW={['21rem', '41rem', '70rem']} h='100vh'>
      <Flex  alignItems={'center'} w='100%'>
        <Box color='white' d='flex' flexDir={'column'} justifyContent={'center'} width={'100%'}>
          ...
          <Text fontSize={'4rem'} _hover={{color: 'black'}}> I am <b>Hope Kumordzie.</b> </Text>
          <Text fontSize={'2.5rem'}> A FullStack Web Developer </Text>
        </Box>
        <Box>
            <Button mb='1rem' _hover={{background: 'red'}} color='white' variant={'outline'}>LATEST PROJECTS</Button>
            <Button color='white' variant={'outline'}>MORE ABOUT ME</Button>
        </Box>
