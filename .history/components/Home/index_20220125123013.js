  ...
  return (
    ...
    <>
      <Flex ref={panelContainer} w='300%' h='100vh' flexWrap={'nowrap'}>
        ...
        <Box id='panel' position={'absolute'} background={'yellow'} d='flex' justifyContent='center' alignItems={'center'} h='100%' w='100%'>

        </Box>
        <Box id='panel' position={'absolute'} background={'red'} d='flex' justifyContent='center' alignItems={'center'} h='100%' w='100%'>
