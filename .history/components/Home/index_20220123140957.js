...
const Home = () => {
  return (
    ...
    <Container d='flex' justifyContent='center' maxW={['21rem', '41rem', '70rem']} h='100vh' background={'red'}>
      <Flex alignItems={'center'} w='100%' flexDir={['column', 'row']} background={'yellow'}>
        <Box color='white' d='flex' flexDir={'column'} justifyContent={'center'} width={'100%'} position={'relative'}>
          <Text color='teal' fontSize='1.4rem' ml='2rem'><hr style={{ display: 'inline-block', width: '2rem', position: 'absolute' }} />HELLO THERE,</Text>
          <Text fontSize={['2rem, 4rem']}> I am <b>Hope Kumordzie.</b> </Text>
