...
const Home = () => {
  return (
    ...
    <Container d='flex' justifyContent='center' alignItems={'center'} maxW={['21rem', '41rem', '70rem']} h='100vh'>
      <Flex background='yellow' mt={['6rem', '0']} alignItems={['flex-start','center']} w='100%' flexDir={['column', 'column', 'row']} fontFamily={'rale'}>
        ...
        <Flex justifyContent={['flex-end']} transition={'all 1s ease-in'} flexDir={['column']} background={'red'}>
