  ...
  return (
    ...
    <>
      <Box w='100vw' overflow={'hidden'}>
        <Flex overscrollBehavior={'none'} ref={panelContainer} w='400%' h='100%' flexWrap={'nowrap'}>
          ...
          <Box id='panel' position={'relative'} background={'yellow'}  justifyContent='center' alignItems={'center'} h='100%' w='100%'>
              <About/>
          </Box>
          <Box id='panel' position={'relative'} background={'red'}  justifyContent='center' alignItems={'center'} h='100%' w='100%'>

          </Box>          
          <Box id='panel' position={'relative'} background={'blue'}  justifyContent='center' alignItems={'center'} h='100%' w='100%'>
