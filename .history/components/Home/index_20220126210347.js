...
const Home = () => {
  ...
  return (
    ...
    <>
      <Box position={'relative'} id='bgTrigger'>
        <Box>
          <Background />
        </Box>
        <Container  d='flex' justifyContent='center' alignItems={'center'} maxW={['21rem', '30rem', '70rem']} h='100vh'>
          <Flex id='bg' mt={['6rem', '0']} alignItems={['flex-start', 'flex-start', 'center']} w='100%' flexDir={['column', 'column', 'row']} fontFamily={'rale'}>
      ...
      <Box d='flex' position={'relative'} h='100vh' w='100%' bg='rgba(0 ,0 ,0, .87)'>
        <About />
      ...
      <Box position={'relative'} background={'red'} h='100vh' w='100%'>
