...
const Home = () => {
  ...
  return (
    ...
    <>
    <Flex w='600%' h='100%' flexWrap={'nowrap'}>
      ...
      <Box  background={'yellow'} d='flex' justifyContent='center' alignItems={'center'} maxW={'100%'} h='100vh'>

      </Box>      
      <Box background={'red'} d='flex' justifyContent='center' alignItems={'center'} maxW={'100%'} h='100vh'>
