  ...
  return (
    ...
    <>
      <Flex w='600%' h='100vh' flexWrap={'nowrap'}>
        ...
        <Box maxW={['21rem', '30rem', '70rem']}'-moz-max-content'position={'relative'} background={'yellow'} d='flex' justifyContent='center' alignItems={'center'} h='100%' w='100%'>

        </Box>
        <Box position={'relative'} background={'red'} d='flex' justifyContent='center' alignItems={'center'} h='100%' w='100%'>
