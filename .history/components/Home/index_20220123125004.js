  ...
  return (
    ...
    <Container d='flex' justifyContent='center' maxW={['21rem', '41rem', '70rem']} h='100vh'>
      <Flex  alignItems={'center'} w='100%'>
        ...
        <Box>
            <Button mb='1rem' colorScheme={'teal'} borderColor={'teal'} color='white' variant={'outline'}>LATEST PROJECTS</Button>
          <Button color='white' variant={'outline'} borderColor={'yellow.200'}>MORE ABOUT ME</Button>
        </Box>
