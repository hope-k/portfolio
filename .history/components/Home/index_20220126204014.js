    ...
    <>
      <Box w='100vw' overflow={'hidden'}>
        <Flex ref={panelContainer} w='400%' h='100%' flexWrap={'nowrap'}>
          <Box id='panel' position={'relative'} w='100vw' h='100%'>
            <Background />
          ...
          <Box id='panel' d='flex' position={'relative'} h='100%' w='1100vw' bg='rgba(0 ,0 ,0, .87)'>
            <About />
      ...
      <Box id='panel' position={'relative'} background={'red'} h='100%' w='100%'>

      </Box>
      <Box id='panel' position={'relative'} background={'blue'} h='100%' w='100%'>
