...
const Home = () => {
  ...
  return (
    ...
    <>
      <Flex w='600%' h='100vh' flexWrap={'nowrap'}>
        <Box position={'relative'}>
          <Background />
          <Container position={} d='flex' justifyContent='center' alignItems={'center'} maxW={['21rem', '30rem', '70rem']} h='100vh'>
        ...
        <Box maxW={['21rem', '30rem', '70rem']} position={'relative'} background={'yellow'} d='flex' justifyContent='center' alignItems={'center'} h='100%' w='100%'>

        </Box>
        <Box maxW={['21rem', '30rem', '70rem']} position={'relative'} background={'red'} d='flex' justifyContent='center' alignItems={'center'} h='100%' w='100%'>
