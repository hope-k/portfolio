...
const Home = () => {
  ...
  return (
    ...
    <>
      <Flex d='flex' w='600%' h='100vh' flexWrap={'nowrap'}>
        <Box position={'relative'} d='flex'>
          <Background />
          ...
          <Box position={'relative'} background={'yellow'} d='flex' justifyContent='center' alignItems={'center'} h='100%'>

          </Box>
          <Box position={'relative'} background={'red'} d='flex' justifyContent='center' alignItems={'center'} h='100%'>
