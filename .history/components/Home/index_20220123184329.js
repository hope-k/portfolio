...
const Home = () => {
  return (
    ...
    <Container d='flex' justifyContent='center' alignItems={'center'} maxW={['21rem', '41rem', '70rem']} h='100vh'>
      <Flex background='yellow' mt={['6rem', '0']} alignItems={'center'} w='100%' flexDir={['column', 'column', 'row']} fontFamily={'rale'}>
        <Box background='blue' mb={['3rem', '4rem', '0']} color='white' d='flex' flexDir={'column'} justifyContent={'center'} width={'100%'} position={'relative'}>
