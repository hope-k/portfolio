...
const Home = () => {
  ...
  return (
    ...
    <Flex w='100%' h='100%'>
      ...
      <Box position={'absolute'} background={'yellow'} d='flex' justifyContent='center' alignItems={'center'} maxW={'100%'} h='100vh'>

      </Box>      
        <Box position={'absolute'} background={'red'} d='flex' justifyContent='center' alignItems={'center'} maxW={'100%'} h='100vh'>
