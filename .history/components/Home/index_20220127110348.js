  ...
  return (
    ...
    <>
      ...
      <Box d='flex'  position={'relative'} bg='rgba(0 ,0 ,0, .87)' h='100vh' w='100%'>
        <Center justifyContent={'center'} alignItems={'center'} m='auto' position={'absolute'} width={'100%'} h='10vh' top={'0'} bg='rgba(0, 0, 0, .1.8)' >
          <Text d='flex' justifyContent={'center'} alignItems={'center'} fontSize={['1rem','4rem']} letterSpacing={['.5rem','2rem']}  fontWeight={'900'} color='rgba(192,192,192,.025)' >
            HK
          </Text>
        </Center>
