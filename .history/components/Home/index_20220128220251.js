...
const Home = () => {
  ...
  useLayoutEffect(() => {
    ...
    t1.from('#line1', { width: 0, ease: 'sine.in', duration: .8 })
      ...
      .from(text3.chars, { y: -60, opacity: 0, color: 'white',  ease: 'Bounce.easeOut', stagger: { each: 0.1, from: 'random' } }, '-=8')
      .to(text3.chars, { color: 'red', textShadow: '0px 0px 15px #fff', ease: 'rough({strength: 5})', stagger: { each: 0.2, from: 'random' }, repeat: -1, repeatDelay: 5 }, '-=8')
  ...
  return (
    ...
    <>
      ...
      <Box d='flex' position={'relative'} h='107vh' w='100%' bg='rgba(0 ,0 ,0, .87)'>
        <About />
      </Box>
