...
const Works = () => {
    ...
    return (
        <Container id='works' d='flex' maxW={['21rem', '30rem', '70rem']} w='100%' h='100%'>
            <Box alignItems={'center'} justifyContent={'center'} w='100%' h='1200px' d='flex'>
                <Flex className='poiret' alignItems={'center'} justifyContent={'center'} top={['3rem', '7rem']} flexDir={'column'} position={'absolute'}>
                ...
                <Container w='100%' d='flex' maxW={['21rem', '30rem', '70rem']}> 
                    <WorkItem
