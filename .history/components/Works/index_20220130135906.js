...
const Works = () => {
    ...
    return (
        <Container id='works' d='flex' maxW={['21rem', '30rem', '70rem']} flexDir={'column'} w='100%' h='100%'>
            <Box alignItems={'center'} justifyContent={'center'} w='100%' h='40vh' d='flex'>
            ...
            <Container w='100%'>
                    <WorkItem
                        laptopMock={'/device/mackbook.png'}
                        phoneMock={'/device/iphone.png'}
