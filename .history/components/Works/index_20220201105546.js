...
const Works = () => {
    ...
    const projects = [
        ...
        },      
        {
            ...
            title: 'BATH BOMB',
            description: `
                Bath bomb is a simple custom shopify storefront i created  where users can view a list of showcased bath bombs. You can add an item to the cart, remove of an item from the cart,
