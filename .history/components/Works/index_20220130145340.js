...
const Works = () => {
    ...
    return (
        <Container id='works' d='flex' maxW={['21rem', '30rem', '70rem']} w='100%' h='100%' justifyContent={'center'}> 
            <Box alignItems={'center'} justifyContent={'center'} w='100%' d='flex'>
                ...
                <Container  position={'relative'} top='20rem' flexWrap={'no-wrap'} bg='red' w='100%' d='flex' maxW={['21rem', '30rem', '70rem']} justifyContent={'center'} alignItems={'center'}> 
                    <WorkItem
