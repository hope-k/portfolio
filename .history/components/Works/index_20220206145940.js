    ...
    const projects = [
        {
            ...
            description: `
                        ...
                        As an admin, you can create new rooms, view all the rooms, update a room, delete a room, view all bookings, delete a booking, view all users registered to the site, delete a user, changed user roles from 'user' -> 'admin' etc.
