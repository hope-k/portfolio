...
const Works = () => {
    ...
    return (
        <Container flexWrap={'wrap'} id='works' d='flex' maxW={['21rem', '30rem', '70rem']} w='100%' h='100%' justifyContent={'center'}> 
            <Box alignItems={'center'} justifyContent={'center'} w='100%' d='flex'>
                ...
                <Container  position={'relative'} top='20rem'  bg='red' w='100%' d='flex' maxW={'60vw'} justifyContent={'center'} alignItems={'center'}> 
                    <WorkItem
                        laptopMock={'/device/macbook.png'}
                        phoneMock={'/devices/iphone.png'}
                        phoneImage={'/device/luxuryspotphone.png'}
                        title={'Luxury Spot'}
                        description={`
                        ...
                        As an admin, you can create new rooms, view all the rooms, update a room, del7te a room, view all bookings, delete a booking, view all users registered to the site, delete a user, changed user roles from 'user' to 'admin.
