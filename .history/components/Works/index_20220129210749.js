...
const Works = () => {
    ...
    return (
        <Container id='works' d='flex' maxW={['21rem', '30rem', '70rem']} justifyContent={'center'} alignItems={'center'}>
                <Flex className='poiret' alignItems={'center'} justifyContent={'center'} top={['3rem', '8rem']} flexDir={'column'} position={'absolute'}>
                    <Text letterSpacing={} transition={'all .14s ease'} mb='.3rem' fontWeight={'bold'} color='teal' ref={worksRef} id='worksSection'>WORKS</Text>
