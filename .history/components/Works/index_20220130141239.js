...
const Works = () => {
    ...
    return (
        <Container flexWrap={'nowrap'} id='works' d='flex' maxW={['21rem', '30rem', '70rem']} w='100%' h='100%'>
            <Box alignItems={'center'} justifyContent={'center'} w='100%' h='1200px' d='flex'>
                ...
                <Container bg='red' flexWrap={'nowrap'} w='100%' d='flex' maxW={['21rem', '30rem', '70rem']} justifyContent={'center'}> 
                    <WorkItem
