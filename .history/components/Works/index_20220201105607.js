    ...
    const projects = [
        {
            ...
            description: `
                        ...
                        Web technologies used in this project - REACT JS , NEXT JS, BOOTSTRAP, CSS MODULES, NODE JS, MONGO DB AND PAYSTACK FOR PROCESSING PAYMENT
                        `,
            link: 'google.com',
            key: 1
        },      
        {
            ...
            title: 'BATH BOMB',
            description: `
                Bath bomb is a simple custom shopify storefront I created using the shopify api. where users can view a list of showcased bath bombs. You can add an item to the cart, remove of an item from the cart,
                and checkout. It is integrated with paystack so users can also pay using 
            `,
            link: 'google.com',
            key: 2
        }
