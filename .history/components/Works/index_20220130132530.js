    ...
    return (
        <Container id='works' d='flex' maxW={['21rem', '30rem', '70rem']}>
            ...
            <WorkItem
                ...
                As an admin, you can create new rooms, view all the rooms, update a room, delete a room, view all bookings, delete a view all users registered to the site, changed user roles from 'user' to 'admin
                `}
